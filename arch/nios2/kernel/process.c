...
void show_regs(struct pt_regs *regs)
{
	...
	pr_debug("r13: %08lx r14: %08lx r15: %08lx\n",
		regs->r13, regs->r14, regs->r15);

	pr_debug("ra: %08lx fp:  %08lx sp: %08lx gp: %08lx\n",
		regs->ra,  regs->fp,  regs->sp,  regs->gp);

	pr_debug("ea: %08lx estatus: %08lx\n",
