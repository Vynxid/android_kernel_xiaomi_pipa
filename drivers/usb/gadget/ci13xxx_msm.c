...
static void ci13xxx_msm_notify_event(struct ci13xxx *udc, unsigned int event)
{
	...
	case CI13XXX_CONTROLLER_DISCONNECT_EVENT:
		dev_dbg(dev, "CI13XXX_CONTROLLER_DISCONNECT_EVENT received\n");
	...
	case CI13XXX_CONTROLLER_RESUME_EVENT:
		dev_dbg(dev, "CI13XXX_CONTROLLER_RESUME_EVENT received\n");
		ci13xxx_msm_resume();
		break;
	case CI13XXX_CONTROLLER_ERROR_EVENT:
		dev_dbg(dev, "CI13XXX_CONTROLLER_ERROR_EVENT received\n");
